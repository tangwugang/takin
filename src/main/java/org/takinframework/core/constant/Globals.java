package org.takinframework.core.constant;
...
public final class Globals {
	...
	public static Short Log_Leavel_ERROR=3;
	 ...
	 public static Short Log_Type_TFKZ=8;//通风控制
	 public static Short Log_Type_CANCHU=9;//仓储管理
	 public static Short Log_Type_CSHU=10;//参数管理
	 public static Short Log_Type_RENY=11;//人员管理
	 public static Short Log_Type_RIZI=12;//操作日志
	 ...
	 static{
		 String button_authority_jeecg = ResourceUtil.getConfig("button.authority.jweb");
